...
spec2_cold = pd.read_csv("../../IMWUT_Data/temp_fluid_exp/Cold/spec_2.csv", usecols = ['1', '2', '5'])
...
spec3_cold = pd.read_csv("../../IMWUT_Data/temp_fluid_exp/Cold/spec_3.csv", usecols = ['1', '2', '5'])
