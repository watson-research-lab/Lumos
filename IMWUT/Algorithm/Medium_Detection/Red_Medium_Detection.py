...
#Import Air Medium
air_df = pd.read_csv("../../../Spectral_Response_of_Medium/Data/IMWUT_Data/Medium/red.csv", usecols = ['1', '2', '5'])
...
fig.savefig("red.pdf", bbox_inches='tight')
print('Done!')