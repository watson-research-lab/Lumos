...
#Import Air Medium
air_df = pd.read_csv("../../../Spectral_Response_of_Medium/Data/IMWUT_Data/Medium/purple.csv", usecols = ['1', '2', '5'])
...
surf = ax.plot_surface(x_new_grid, y_new_grid, z_new, cmap=cm.CMRmap,vmin = -3000, vmax = 15000)
