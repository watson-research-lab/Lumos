...
#Import Air Medium
air_df = pd.read_csv("../../../Spectral_Response_of_Medium/Data/IMWUT_Data/Medium/orange.csv", usecols = ['1', '2', '5'])
air_df = process_df(air_df)
air_df = air_df.sort_values('timestamp')
air_df = air_df.iloc[:-400]
...
surf = ax.plot_surface(x_new_grid, y_new_grid, z_new, cmap=cm.CMRmap,vmin = -3000, vmax = 20000)
...
# peaks,_ = find_peaks(z_new2, prominence =(0.8, 1), distance = 15000)
peaks, _ = find_peaks(z_new2, prominence=(15000, 65535))
...
print("znew2 MAX")
print(max(z_new2))
print(y_new2[np.where(z_new2 ==max(z_new2))])
print("z values MAX")
print(array_temp_MAX)
print("y values MAX")
...
fig.savefig("orange.pdf", bbox_inches='tight')
print('Done!')